CREATE OR REPLACE FUNCTION mishipay_item_inventory_InsertRecords1(in a_no_of_records integer) RETURNS integer AS $$
DECLARE
    v_counter integer;
...
select * from mishipay_item_inventory_InsertRecords1(20);
...
CREATE OR REPLACE FUNCTION mishipay_item_inventory_index_InsertRecords1(in a_no_of_records integer) RETURNS integer AS $$
DECLARE
    v_counter integer;
    v_productname varchar(255);
    v_date varchar(15);
...
CREATE OR REPLACE FUNCTION mishipay_item_inventory_store_dpt_index_InsertRecords1(in a_no_of_records integer) RETURNS integer AS $$
DECLARE
    v_counter integer;
    v_productname varchar(255);
    v_date varchar(15);
...
--8) Run to create data 
select * from mishipay_item_inventory_store_dpt_InsertRecords1(20);
